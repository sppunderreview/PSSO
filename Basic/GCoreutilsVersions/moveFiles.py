...
for idS in tableIdPath:
	...
	if name in programTaken:
		continue
	if  ("binaries/coreutils-5.93-O3/"+name in pathsExist) and ("binaries/coreutils-6.4-O3/"+name in pathsExist) and ("binaries/coreutils-7.6-O3/"+name in pathsExist) and ("binaries/coreutils-8.30-O3/"+name  in pathsExist) :
