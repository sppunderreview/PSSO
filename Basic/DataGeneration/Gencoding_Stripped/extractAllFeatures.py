...
listProgram = [f for f in os.listdir("programs") if os.path.isfile(os.path.join("programs", f))]
jsonFinal = ""

for program in listProgram:	
	os.system("mv programs/"+program+" "+program)
...
f = open("extractedGeminiStripped.json","w")
f.write(jsonFinal)
f.close()
