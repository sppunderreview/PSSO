...
print("Need 5 hours divided by the number of core")
PN = 1 # Number of processors

print("Hello, here is the script to replay the disassembly of Basic datasets with IDA.\n")

print("Enter the path to IDApro v7.5 idat64:") 
pathIda64 = input()
print("Enter the absolute path to the 'ExtractBinaryIDA.py' script inside 'Motivating' folder:") 
pathScript = input()
