...
print("Enter the absolute path to the 'ExtractBytesIDA.py' script:") 
pathScript = input() # /home/tristan/Documents/Travail/These/Artefact/BinKiT/normal/DataGenerator/ExtractBytesIDA.py
...
def extractDataFromProgram(goodware, myId, maxId):
	...
	for pathString in L:				
		...
		pathTobeMoved = "bytes/"+fileName+"_bytes.json"
