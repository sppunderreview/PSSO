...
with open("ELAPSED_SCs_Ablation_NORMAL", "rb") as f:
    ELAPSED_SCs_NORMAL  = pickle.load(f)

with open("ELAPSED_SCs_Ablation_OBF", "rb") as f:
...
for nEmb in ELAPSED_SCs:
    ...
    print(nEmb, SCs, N, SCs/N)

# simCG  202899.15104198456 1391184 0.14584638052334167
# simCFG 200155.8525595665  1391184 0.143874464168339