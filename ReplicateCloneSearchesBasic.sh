...
echo 'Alpha Diff'
echo '650 hours divided by the number of cores (40)'
...
echo 'Asm2Vec'
echo '150 hours divided by the number of cores (40)'
#cd Asm2vec/gDist/
#cd ASM_BO_gDist/
#unzip vecByIds.zip
#python3 Run.py
...
echo 'CGC'
echo '170 hours divided by the number of cores (30)'
#cd CGC/
#python3 Run.py
...
echo 'LibDB'
echo '16 hours divided by the number of cores (default : 40)'
#cd LibDB/
#python3 RunMakeMD.py
#cd ../
...
echo 'SAFE'
echo '700 hours divided by the number of cores (40)'
#cd SAFE/S_gDist/
#python3 Run.py
#cp BO/*_* ../makeResults/BO/
#cp BV/*_* ../makeResults/BV/
...
echo 'SMIT'
echo '3700 hours divided by the number of cores (40)'
#cd SMIT/
#cd NBHA/
