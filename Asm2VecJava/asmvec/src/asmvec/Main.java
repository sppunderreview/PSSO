...
public final class Main {
	...
	{
		String pathToData = "/home/tristan/Documents/Travail/These/Virus/samples/";	
	...
	public static void main(String[] args) throws Exception
	{
		String pathToData = "/home/tristan/Documents/Travail/These/LinuxDataset/normal/motivating/programsASM/";	
	...
	*/
	...
	public static void main(String[] args) throws Exception
	{
		String nameEXP = "test";
		String nameId = "1";
		String pathToData = "/home/tristan/Documents/Travail/These/BigC/BOC/";	
		Integer epochs = 1;
		String part0 = "O0";
		String part1 = "O1";
	...
	public static void main(String[] args) throws Exception
	{
		String pathToData = "/home/tristan/Documents/Travail/These/BigOptions/samples/";	
	...
	public static void main(String[] args) throws Exception
	{
		if (args.length != 3)
		{
			System.out.println("Need 3 arguments:\n1) The path to the 'samples' folder.\n2) The absolute path to IDApro v7.5.\n3) The absolute path to the 'ExtractBinaryIDA.py' script.");
			return;			
		}
		
		String pathToData = args[0];
		String pathToIda = args[1];
		String pathToIdaScript  = args[2];
		
		//pathToData  "/home/tristan/Documents/Travail/These/Artefact/Basic/DataGenerator/Datasets/CoreutilsVersions/samples"
		//pathToIda  "/home/tristan/idapro-7.5"
		//pathToIdaScript "/home/tristan/Documents/Travail/These/Artefact/Basic/DataGenerator/JsonExtractor/ExtractBinaryIDA.py"		
	 	// "/home/tristan/idapro-7.5"
		// "/home/tristan/Documents/Travail/These/asm2veck/ExtractBinaryViaIDA2.py"
		
		Set<String> functionsToRemove = new HashSet<String>();
		DisassemblyFactory factory  = DisassemblyFactory.getDefaultDisassemblyFactory(pathToIda, pathToIdaScript);
		

		// Binary
		File folder = new File(pathToData);
		List<File> filesInFolder = new ArrayList<File>(Arrays.asList(folder.listFiles()));		
		for (File fTrain  : filesInFolder)
		{
			List<Binary> bList = new ArrayList<Binary>();		
			Binary bTrain = DisassemblyFactory.disassembleSingle(fTrain,factory).processRawBinarySurrogate().toBinary();		
			bList.add(bTrain);
		...
		try (Writer writer = new BufferedWriter(new OutputStreamWriter(
	              new FileOutputStream(pathToData+"/../functionsToRemove.txt"), "utf-8")))
		{
			writer.write(functionsToRemove.toString());
		}
	}
