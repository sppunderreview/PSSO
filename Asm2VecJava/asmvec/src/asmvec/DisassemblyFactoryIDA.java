...
public class DisassemblyFactoryIDA extends DisassemblyFactory {
	...
	public DisassemblyFactoryIDA(String idaPath, String scriptPath, int bathSize) {
	...
	public DisassemblyFactoryIDA(String idaPath, String scriptPath) {
		this(idaPath, scriptPath, 10000);
	}
