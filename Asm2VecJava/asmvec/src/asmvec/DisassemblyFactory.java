...
public abstract class DisassemblyFactory {
	...
	public static DisassemblyFactory getDefaultDisassemblyFactory(String idaPath, String scriptPath) {
		DisassemblyFactoryIDA factory = new DisassemblyFactoryIDA(idaPath, scriptPath);
		factory.init();
		return factory;
	}
	
	public static DisassemblyFactory getSimpleDisassemblyFactory() {
		DisassemblyFactorySimple factory = new DisassemblyFactorySimple();
		factory.init();
		return factory;
	}
